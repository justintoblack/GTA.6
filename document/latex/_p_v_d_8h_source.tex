\hypertarget{_p_v_d_8h_source}{}\doxysection{PVD.\+h}
\label{_p_v_d_8h_source}\index{src/Common/PVD.h@{src/Common/PVD.h}}
...
\DoxyCodeLine{29 }
\DoxyCodeLine{30 }
\DoxyCodeLine{31 \textcolor{preprocessor}{\#ifndef PHYSX\_SNIPPET\_PVD\_H}}
\DoxyCodeLine{32 \textcolor{preprocessor}{\#define PHYSX\_SNIPPET\_PVD\_H}}
\DoxyCodeLine{33 }
\DoxyCodeLine{34 \textcolor{preprocessor}{\#define PVD\_HOST "{}127.0.0.1"{}}    \textcolor{comment}{//Set this to the IP address of the system running the PhysX Visual Debugger that you want to connect to.}}
\DoxyCodeLine{35 }
\DoxyCodeLine{36 \textcolor{preprocessor}{\#endif }\textcolor{comment}{//PHYSX\_SNIPPET\_PVD\_H}}
